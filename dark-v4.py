...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=6287821505106&text=Assalamualaikum')
...
if sandi == 'CyberLimitedEdtion' and user == 'RahmanSucipto':
    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.youtube.com/channel/UC6Q01VmRedwy8htW4jy2Yog')
                time.sleep(1)
                menu()
